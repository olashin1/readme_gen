...
def make_http_error(
    ...
    """
    Create an HTTPError suitable for exercising client error handling.
    """
    return urllib.error.HTTPError(
        url="https://api.github.com/example",
        code=status_code,
        msg="Test error",
        hdrs=headers or {}, # type: ignore
        fp=None,
    )
...
def make_zip_bytes() -> bytes:
    """
    Create an in-memory repository ZIP matching GitHub's archive shape.
    """
    buffer = io.BytesIO()
